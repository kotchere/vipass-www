...
const features = [
  ...
  },
  {
    ...
    containerClass: "framer-8xpe05-container",
  },
];

function FeatureItemOpen({
  number,
  title,
  description,
  images,
  ...
  return (
    <div className={containerClass} style={{ opacity: 1 }}>
      <div
        className="framer-ssEy5 framer-PU6Rs framer-loOMQ framer-RKppn framer-1nd063s framer-v-1nd063s"
        data-border="true"
      ...
      >
        ...
        >
          <div className="framer-174h6l6" data-framer-name="Text" style={{ opacity: 1 }}>
            <div className="framer-1qdqpra" data-framer-name="1" style={{ opacity: 1 }}>
              ...
              <div className="framer-1t0yt9s" data-framer-name="Images" style={{ opacity: 1 }}>
                ...
                <div
                  className="framer-rbfec2"
                  data-framer-name="Image-1"
                  style={{
                    borderRadius: 14,
                    boxShadow: IMAGE_BOX_SHADOW,
                    opacity: 1,
                  }}
                >
                  <div
          ...
          {/* Service title (hidden in open state) */}
          <div
...
function FeatureItemClosed({
  ...
  return (
    <div className={containerClass} style={{ opacity: 1 }}>
      <div
        className="framer-ssEy5 framer-PU6Rs framer-loOMQ framer-RKppn framer-1nd063s framer-v-1cek2le"
        data-border="true"
      ...
      >
        ...
        >
          <div className="framer-174h6l6" data-framer-name="Text" style={{ opacity: 0 }}>
            <div className="framer-1qdqpra" data-framer-name="1" style={{ opacity: 1 }}>
              {/* Stacked images */}
              <div className="framer-1t0yt9s" data-framer-name="Images" style={{ opacity: 1 }}>
                <div
          ...
          {/* Arrow button (rotated for closed state) */}
          <div
            className="framer-koycop"
            data-border="true"
            data-framer-name="Button"
          ...
          {/* Service title (visible in closed state) */}
          <div
            className="framer-1pna3mw"
            data-framer-name="Service Title"
            data-framer-component-type="RichTextContainer"
    ...
    <section className="framer-8d5aox" data-framer-name="Features" id="features">
      <div className="framer-o7lid4" data-framer-name="Container">
        ...
        <div className="ssr-variant hidden-f3lv8x hidden-tsn51j">
          <div
            className="framer-1hh6mhy-container"
            style={{ height: "438.812px" }}
          >
            <div
            ...
            >
              ...
              {features.map((feature, index) =>
                index === 0 ? (
                  <FeatureItemOpen key={feature.number} {...feature} />
                ) : (
                  <FeatureItemClosed key={feature.number} {...feature} />
                )
              )}
            </div>
          </div>
